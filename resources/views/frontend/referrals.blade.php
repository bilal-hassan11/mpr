        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-header">
                    <span class="cate">You are a member of something big</span>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="tot-area">
                            ...
                            <div class="tot-item">
                                ...
                                <div class="tot-content">
                                    <div class="counter--item">
                                        <div class="counter-header">
                                            <h2 class="title odometer" data-odometer-final="17.8">0</h2>
                                            <h2 class="title">K</h2>
                                        </div>
                                        <p>
                                            Users Worldwide
                        ...
                        <div class="tot-area">
                            <div class="tot-item">
                                ...
                                <div class="tot-content">
                                    <div class="counter--item">
                                        <div class="counter-header">
                                            <h2 class="title odometer" data-odometer-final="9.8">0</h2>
                                            <h2 class="title">k</h2>
                                        </div>
                                        <p>
                                            Popular Investors
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-header">
                    ...
                    <p>
                        We have simple steps to start earning, create an account and select your plan, invest, and start earning.
                    </p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center mb-30-none">
            ...
            <div class="col-md-6 col-lg-4 col-sm-10">
                <div class="how-item active">
                    ...
                    <div class="how-content">
                        <h5 class="title">Start Investing</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 col-sm-10">
            ...
            <div class="col-lg-6">
                <div class="why-affiliate-content">
                    <div class="section-header left-style">
                        ...
                        <h2 class="title">Join Referrals?</h2>
                        <p>
                            We give an exclusive feature to our faithful investors called the Referrals program.
                        </p>
                    </div>
                    <div class="why-area">
                        <div class="why-item">
