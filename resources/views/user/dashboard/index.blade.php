...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('user_assets/plugins/chartist/dist/chartist.min.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{ asset('user_assets/images/users/1.jpg') }}" alt="user" class="profile-pic me-2">Markarn Doe
                            </a>
            ...
            <div class="container-fluid">
                                ...
                                <div class="table-responsive mt-5">
                                    <table class="table stylish-table no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="active">
                                                <td><span class="round"><img src="{{ asset('user_assets/images/users/2.jpg') }}"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            <img class="card-img-top img-responsive" src="{{ asset('user_assets/images/big/img1.jpgf') }}" alt="Card">
                            <div class="card-body">
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{ asset('user_assets/plugins/jquery/dist/jquery.min.js') }}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{ asset('user_assets/plugins/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{  asset('user_assets/js/app-style-switcher.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{  asset('user_assets/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    ...
    <!--flot chart-->
    <script src="{{ asset('user_assets/plugins/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('user_assets/plugins/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ asset('user_assets/js/pages/dashboards/dashboard1.js') }}"></script>
