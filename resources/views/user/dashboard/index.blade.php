...
<!-- date picker  -->
<script src="{{ asset('user_assets/vendors/datepicker/datepicker.js') }}"></script>
<script src="{{ asset('user_assets/vendors/datepicker/datepicker.en.js') }}"></script>
<script src="{{ asset('user_assets/vendors/datepicker/datepicker.custom.js') }}"></script>
...
<!-- tag input -->
<script src="{{ asset('user_assest/vendors/tagsinput/tagsinput.js') }}"></script>
<!-- text editor js -->
<script src="{{ asset('user_assets/vendors/text_editor/summernote-bs4.js') }}"></script>
<script src="{{ asset('user_assets/vendors/am_chart/amcharts.js') }}"></script>

<script src="{{ asset('user_assets/vendors/apex_chart/apexcharts.js') }}"></script>
<script src="{{ asset('user_assets/vendors/apex_chart/apex_realestate.js') }}"></script>
<!-- <script src="vendors/apex_chart/default.js"></script> -->

<script src="{{ asset('user_assets/vendors/chart_am/core.js') }}"></script>
<script src="{{ asset('user_assets/vendors/chart_am/charts.js') }}"></script>
<script src="{{ asset('user_assets/vendors/chart_am/animated.js') }}"></script>
<script src="{{ asset('user_assets/vendors/chart_am/kelly.js') }}"></script>
<script src="{{ asset('user_assets/vendors/chart_am/chart-custom.js') }}"></script>
<!-- custom js -->
<script src="{{ asset('user_assets/js/custom.js') }}"></script>

<script src="{{ asset('user_assets/vendors/apex_chart/bar_active_1.js') }}"></script>
<script src="{{ asset('user_assets/vendors/apex_chart/apex_chart_list.js') }}"></script>

<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/parsley.js/2.9.2/parsley.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.form/4.3.0/jquery.form.min.js"></script>
<script src="{{ asset('user_assets/custom/custom.js') }}"></script>
</body>
</html>
